...
//           if (Object.keys(cartItem)[0] === item[0].id.toString()) {
//             return { [item[0].id]: item.quantity };
//           }
//           return cartItem;
//         });
...
//             "Price:" + item[0].price * item.quantity + "$";
//         }
//       };
...
//           (cartItem) => Object.keys(cartItem)[0] !== item[0].id.toString()
//         );
//         localStorage.setItem("cart", JSON.stringify(cart));
//         container.innerHTML = "";
//         CartShopPage();
